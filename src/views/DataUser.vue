      ...
      <v-card>
        ...
        <v-card class="dialogField mt-5 pb-5">
          <v-container>
            <v-row class="pt-5">
              <v-col cols="12" sm="12">
                <v-text-field label="Pilih Hak Akses" filled></v-text-field>
              </v-col>
              <v-col cols="12" sm="12">
                <v-text-field label="Pilih User" filled></v-text-field>
              </v-col>
              <v-col cols="12" sm="12">
              ...
              <v-col cols="12" sm="12">
                <v-text-field label="Ulangi Password" filled></v-text-field>
              </v-col>
            </v-row>
          </v-container>
        </v-card>
