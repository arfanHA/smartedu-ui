                ...
                >
                  ...
                  <v-layout row wrap>
                    ...
                    <v-col
                      cols="1"
                      sm="1"
                      v-for="(aa, xx) in index.total_pertemuan"
                      :key="xx"
                    >
                      <v-text-field
                        type="number"
                        v-model="dataNilaiPertemuan[ix].nil[xx]"
                        required
                        outlined
                      ></v-text-field>
                    </v-col>
          ...
          <tbody>
            <tr v-for="(item, index) in items" :key="item.id">
              ...
              <td class="text-xs-right">
                {{ item.rincian_nilai[0].hasil }}
              </td>
              <td class="text-xs-right">
                {{ item.rincian_nilai[1].hasil }}
              </td>
              <td class="text-xs-right">
                {{ item.rincian_nilai[2].hasil }}
              </td>
              <td class="text-xs-right">
                {{ item.rincian_nilai[3].hasil }}
              </td>
              <td class="text-xs-right">
                {{ item.rincian_nilai[4].hasil }}
              </td>
              <td class="text-xs-right">
                {{ item.rincian_nilai[5].hasil }}
              </td>
              <td class="text-xs-right">
                {{ item.total_nilai }}
              </td>
    ...
    processEdit() {
      ...
      if (this.$refs.form.validate() === true) {
        ...
        this.dataNilaiPertemuan.forEach((element) => {
          this.dataSend.push({
            pengaturan_penilaian_id: element.pengaturan_penilaian_id,
            nil: element.nil,
          });
          console.log(element);
        });
