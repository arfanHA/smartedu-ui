          ...
          <v-row justify="center">
            <v-col cols="12" sm="5">
              ...
              <h3 class="font-weight-light mt-3">
                Apabila mengalami kendala terhadap sistem SmartEducation
                silahkan mengirimkan pesan melalui form yang tersedia disamping 
                kanan tulisan ini, atau dengan menghubungi Administrator.
              </h3>
              <h3 class="font-weight-light mt-3">
